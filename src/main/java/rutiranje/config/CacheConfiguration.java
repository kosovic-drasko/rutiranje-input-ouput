...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, rutiranje.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, rutiranje.repository.UserRepository.USERS_BY_EMAIL_CACHE);
