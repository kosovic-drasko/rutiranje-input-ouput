...
import rutiranje.service.SpecifikacijeQueryService;
import rutiranje.service.SpecifikacijeService;
...
/**
 * REST controller for managing {@link rutiranje.domain.Specifikacije}.
 */
@RestController
@RequestMapping("/api")
public class SpecifikacijeResource {
    ...
    public ResponseEntity<List<Specifikacije>> getAllSpecifikacijes(
        SpecifikacijeCriteria criteria,
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get Specifikacijes by criteria: {}", criteria);
        Page<Specifikacije> page = specifikacijeQueryService.findByCriteria(criteria, pageable);
